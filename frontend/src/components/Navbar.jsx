...
import reallogo from "../assets/sahyog-high-resolution-logo-black.svg";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={reallogo} alt="logo" className="w-9 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex ">
            Project &nbsp;
            <span className="sm:block hidden">| Sahyog</span>
          </p>
        </Link>
              ...
              {navLinks.map((nav) => (
                <li
                  ...
                  className={`font-poppins font-medium cursor-pointer text-[16px] ${
                    active === nav.title ? "text-white glow" : "text-secondary"
                  }`}
                  onClick={() => {
                    setToggle(!toggle);
                    setActive(nav.title);
